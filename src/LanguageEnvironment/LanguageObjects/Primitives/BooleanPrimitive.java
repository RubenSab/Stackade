...
public class BooleanPrimitive extends Primitive<Boolean> {
    ...
    public BooleanPrimitive not() {
        return new BooleanPrimitive(!getValue());
    }

    public BooleanPrimitive and(BooleanPrimitive o) {
        return new BooleanPrimitive(getValue() && o.getValue());
    }

    public BooleanPrimitive or(BooleanPrimitive o) {
        return new BooleanPrimitive(getValue() || o.getValue());
    }

    public BooleanPrimitive xor(BooleanPrimitive o) {
        return new BooleanPrimitive(getValue() ^ o.getValue());
    }
